...
namespace BHD.Documents.TEST.IntegrationTest.Controllers;
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            var descriptorsToRemove = services
                .Where(d => d.ServiceType.FullName?.Contains("DataContext") == true ||
                           d.ImplementationType?.FullName?.Contains("DataContext") == true)
                .ToList();
